...
variable "python_runtime" {
  type        = string
  description = "Runtime version of Python, eg. python3.13, python3.12, python3.11, python3.10, python3.9"
  default     = "python3.13"
  validation {
    condition     = contains(["python3.13", "python3.12", "python3.11", "python3.10", "python3.9", null], var.python_runtime)
